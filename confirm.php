          ...
          <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.html"><span class="fw-bold text-uppercase text-dark">Boutique</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                  <!-- Link--><a class="nav-link" href="detail.html">下架區</a>
                </li>
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="pagesDropdown" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">貼文</a>
                  <div class="dropdown-menu mt-3 shadow-sm" aria-labelledby="pagesDropdown">
                    <a class="dropdown-item border-0 transition-link" href="index.html">代發拾獲貼文</a>
                    <a class="dropdown-item border-0 transition-link" href="cart.html">未審核貼文區</a>
                    <a class="dropdown-item border-0 transition-link" href="detail.html">(已審核)貼文區</a>
                    <a class="dropdown-item border-0 transition-link" href="cart.html">尋物啟事</a>
                </li>
              </ul>
              ...
              <div class="row align-items-stretch">
                ...
                <div class="col-lg-6">
                  <div class="p-4 my-md-4">
                    ...
                    <div id="button"><center><a class="btn btn-sm btn-outline-dark" href="confirm/confirm_update.php?id=<?php echo $id ?>">認證</a><a class="btn btn-sm btn-outline-dark" href="confirm/delete.php?id=<?php echo $id ?>">刪除</a><center></div>
                  </div>
                </div>
              </div>
            </div>
